...
If you plan to maintain a single node Chipster server for a longer period of time, consider storing data on [`hostPath`](#change-k3s-version.md), which makes it easier to reinstall K3s if ever needed.
