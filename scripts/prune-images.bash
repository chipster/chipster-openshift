...
skopeo login -u $username -p $token image-registry.apps.2.rahti.csc.fi
...
skopeo copy docker://image-registry.apps.2.rahti.csc.fi/$namespace/$imagestream:latest docker://image-registry.apps.2.rahti.csc.fi/$namespace/$imagestream:latest-copy

oc tag -d $imagestream:latest

# oc tag $imagestream:latest-copy $imagestream:latest
skopeo copy docker://image-registry.apps.2.rahti.csc.fi/$namespace/$imagestream:latest-copy docker://image-registry.apps.2.rahti.csc.fi/$namespace/$imagestream:latest
